...
STBIDEF stbi_uc *stbi_load_from_rwops(SDL_RWops *rw, int *x, int *y, int *comp, int req_comp);
...
STBIDEF stbi_uc *stbi_load_from_callbacks  (stbi_io_callbacks const *clbk, void *user, int *x, int *y, int *comp, int req_comp);
   ...
   #endif
	STBIDEF float *stbi_loadf_from_rwops(SDL_RWops *rw, int len, int *x, int *y, int *comp, int req_comp);
