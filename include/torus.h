...
public:
	...
	std::shared_ptr<BufferBuilder> getVertices() {
		return vertexBuffer;
	};
	std::shared_ptr<BufferBuilder> getNormals() {
		return normalBuffer;
	};
	std::shared_ptr<BufferBuilder> getUVs() {
		return uvBuffer;
	};
	std::shared_ptr<BufferBuilder> getIndices() {
		return indexBuffer;
	};
	std::shared_ptr<Buffer>        make_vertices();
	std::shared_ptr<Buffer>        make_indices();
};
